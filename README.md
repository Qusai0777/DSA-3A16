...
bool isBST(struct TreeNode* root, struct TreeNode* left, struct TreeNode* right) {                               //IS BST (IN BUILD FUNCTION )  FOR CHECKING BST OR NOT 

    if (root == NULL)                                                                                              //IF - IF LADER 
        return true;
...
// BUILDING OUR BST TREE FOR CHECKING PURPOSE 
